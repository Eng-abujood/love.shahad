document.addEventListener('DOMContentLoaded', () => {
    ...
    async function startAnimationSequence() {
        ...
        setTimeout(() => {
            tagline.innerText = "لما قلتيلي بدك وردة قلتلك اصبري علي صح حبيبتي... لأنه الوردة الحقيقية بتذبل بيومين بس الوردة اللي ببنيلك ياها بكودي وبمشاعري رح تضل عايشة ومزهرة طول العمر كل سطر برمجته وكل تفصيل بيتفتح بهالوردة كان عم يفكر فيكي شكراً لأنك صبرتي علي وشكراً لأنك الوردة الأحلى بحياتي بموت فيكي شهد بعشقك بعشق الارض الي انتي عليها 🌹";
